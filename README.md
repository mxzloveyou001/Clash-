...
proxies:
  - {name: "☁️ CFWarp-A",type: wireguard,server: 162.159.192.128,port: 1010,ip: 172.16.0.2,private-key: 4Oz80bIljm6+3stx5SkEeGpDVY+Z/nMj+CK1APOKdVE=,public-key: bmXOC+F1FxEMF9dyiK2H5/1SUtzH0JuVo51h2wPfgyo=,remote-dns-resolve: false,udp: true}
  - {name: "☁️ CFWarp-B",type: wireguard,server: 162.159.192.247,port: 1010,ip: 172.16.0.2,private-key: 4Oz80bIljm6+3stx5SkEeGpDVY+Z/nMj+CK1APOKdVE=,public-key: bmXOC+F1FxEMF9dyiK2H5/1SUtzH0JuVo51h2wPfgyo=,remote-dns-resolve: false,udp: true}
  - {name: "☁️ CFWarp-C",type: wireguard,server: 188.114.99.28,port: 854,ip: 172.16.0.2,private-key: 4Oz80bIljm6+3stx5SkEeGpDVY+Z/nMj+CK1APOKdVE=,public-key: bmXOC+F1FxEMF9dyiK2H5/1SUtzH0JuVo51h2wPfgyo=,remote-dns-resolve: false,udp: true}
  - {name: "☁️ CFWarp-D",type: wireguard,server: 188.114.96.140,port: 1010,ip: 172.16.0.2,private-key: SHVqHEGI7k2+OQ/oWMmWY2EQObbRQjRBdDPimh0h1WY=,public-key: bmXOC+F1FxEMF9dyiK2H5/1SUtzH0JuVo51h2wPfgyo=,remote-dns-resolve: false,udp: true}
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
